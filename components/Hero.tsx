      ...
      <div className="relative mx-auto grid max-w-6xl gap-10 px-4 py-24 sm:py-32 lg:grid-cols-[1.4fr_0.9fr] lg:items-end">
        <div className="max-w-2xl text-center lg:text-left">
          <h1 className="mt-6 text-4xl font-extrabold tracking-tight text-white sm:text-6xl">
            Discover <span className="gradient-text">the Beautifull Pakistan</span>
          </h1>
          <p className="mt-5 max-w-xl text-base text-slate-200 sm:text-lg">
            Explore breathtaking destinations from snow-capped mountains to sun-kissed coastal cities. Get personalized travel suggestions, route planning tools, and real-time local insights for your ideal Pakistan journey.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-3 lg:justify-start">
            <Link
              href="/destinations"
              className="inline-flex items-center gap-2 rounded-xl bg-green-600 px-5 py-3 text-sm font-semibold text-white shadow-xl shadow-green-500/30 transition-all duration-300 hover:bg-green-500 hover:scale-100"
            >
              Your Desire destinations <ArrowRight size={16} />
            </Link>
            <Link
              href="/about"
